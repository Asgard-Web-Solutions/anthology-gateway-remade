            ...
            <div class="max-w-3xl p-6 mx-auto text-gray-300 bg-gray-900 rounded-md shadow-sm">
                ...
                <form >
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="name" name="name" value="{{ $social['name'] }}" wire:model="social.name" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5">
                        {{-- <input type="text" wire:model="socialName" value="{{ $socialName }}"> --}}
                    </div>
