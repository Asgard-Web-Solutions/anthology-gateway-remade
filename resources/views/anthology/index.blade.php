                        ...
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="hidden px-6 py-4 border-b border-grey-light sm:table-cell">
                                @if ($anthology->publisher_id)
                                    <a class="text-purple-600 underline hover:text-purple-900 hover:no-underline" href="{{ route('publisher.view', $anthology->publisher->id) }}">{{ $anthology->publisher->name }}</a>
                                @endif
                            </td>
